...
class PhongBall:
    ...
    def __metal(self):
        self.k_a = [0.1, 0.1, 0.1]
        self.k_d = [0.4, 0.4, 0.4]
        self.k_s = [0.8, 0.8, 0.8]
        self.spec_pow = 100
        self.light_col = [0.752941, 0.752941, 0.878431]

    def __plastic(self):
        self.k_a = [0.1, 0.1, 0.1]
        self.k_d = [0.8, 0.8, 0.8]
        self.k_s = [0.1, 0.1, 0.1]
        self.spec_pow = 10
        self.light_col = [0, 1, 0]

    def __wood(self):
        self.k_a = [0.1, 0.1, 0.1]
        self.k_d = [0.8, 0.8, 0.8]
        self.k_s = [0.05, 0.05, 0.05]
        self.spec_pow = 5
        self.light_col = [0.6, 0.298039, 0]

    def __wall(self):
        self.k_a = [0.2, 0.2, 0.2]
        self.k_d = [0.2, 0.2, 0.2]
        self.k_s = [0.05, 0.05, 0.05]
        self.specular_power = 2
        self.light_col = [0.878431, 0.878431, 0.878431]

    def reset_light_pos(self):
        self.light_pos = [200, 400, 500]
